addLayer("w", {
  ...
  //      else return 0},
    ...
    tabFormat: [
        ...
        "resource-display",
        ["display-text",
            function() { return 'UNFINISHED. END OF GAME. PLEASE DO NOT PURCHASE SAND OR WOOD.' },
            { "color": "red", "font-size": "16px" }],
    ],
 //   onPrestige()
    color: "#572E1C",
    requires: new Decimal(2e38), // Can be a function that takes requirement increases into account
